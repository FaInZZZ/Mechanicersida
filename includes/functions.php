...
function nyprjkt($pdo) {
    ...
    $stmt_inserpjk = $pdo->prepare('INSERT INTO table_projekt (customer_fk, pt_felbeskrivning, pt_arbetsbeskrivning) 
                                      VALUES (:)');

    $stmt_inserpjk->bindParam(':cust_fname', $_POST['namn'], PDO::PARAM_STR);
    $stmt_inserpjk->bindParam(':cust_lname', $_POST['enamn'], PDO::PARAM_STR);
    $stmt_inserpjk->bindParam(':cust_tel', $_POST['telefon'], PDO::PARAM_STR);
    $stmt_inserpjk->bindParam(':cust_epost', $_POST['epost'], PDO::PARAM_STR);
    $stmt_inserpjk->bindParam(':cust_adress', $_POST['adress'], PDO::PARAM_STR);
    $stmt_inserpjk->bindParam(':cust_postnummer', $_POST['postnummer'], PDO::PARAM_STR);
    $stmt_inserpjk->bindParam(':cust_ort', $_POST['ort'], PDO::PARAM_STR);
